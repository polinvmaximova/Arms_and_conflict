...
africa_arms <- read_excel("/Users/polina/Desktop/МИРПОЛ (4 курс)/Security /Arms trade and conflict sources/data/arms_trade_africa.xlsx")
save(africa_arms, file="africa_arms.RData")
africa_arms %>%
  filter(country == "Cameroon" & conflict_end == 1)
...
cox.zph(cox_m4_adj) # The test no longer shows problems with the proportional hazard assumption.
